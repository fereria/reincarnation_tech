---
slug: /houdini/solaris/value_clip
...
以前書いた [Value Clips を使おう](/usd/value_clip_1) で説明している時間方向（TimeSampling）の
レイヤー分割をする機能を使用できます。
しかし、このノードの場合は、
...
<XEmbed url="https://x.com/suamaGod/status/1567403383568633857" />
