...
slug: /usd/python/tutorials/04
sidebar_position: 4
---

これまでに、[0 から始める USDPython(1)](/usd/python/tutorials/01) では、
...
![](https://gyazo.com/98c664089ff5e4257f21cae0a15dd7b2.png)
...
[0 から始める USDPython(1)](/usd/python/tutorials/01)で、上書き保存するときに
