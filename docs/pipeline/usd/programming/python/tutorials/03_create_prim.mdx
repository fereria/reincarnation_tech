...
sidebar_position: 3
slug: /usd/python/tutorials/03
---

[ 0 から始める USDPython(1)](/usd/python/tutorials/01) と [0 から始める USDPython(2) ステージを検索しよう](/usd/python/tutorials/02) ではすでに作成されている USD ファイルの読み方と変更方法をやっていきましたが
...
USD では、このデータの型を定義するための構造を「 <AutoLinkTitle url="/usd/schema" /> 」と呼びます。
