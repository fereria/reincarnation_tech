...
<Gist id="bed418960fb87912b9f31f1dd4d8c662" file="load_abc.usda" />
...
<Gist id="ee68e70cbd5268b893210c5a051cdde7" file="assign_material.usda" />
...
まずは、<ExpandLink url="/usd/asset_resolution_01" /> で USD をビルドしておきます。
