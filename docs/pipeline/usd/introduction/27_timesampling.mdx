...
slug: /usd/time_sampling
---

[USD AdventCalendar2022](https://qiita.com/advent-calendar/2022/usd)13 日目は、USD の TimeSampling です。

USD は、キャラクターのアニメーションなどは、 <AutoLinkTitle url="/usd/value_clip_1" /> にもあるようにジオメトリキャッシュを使用しますが
...
どうしておくといいか？というと、以前に書いた <AutoLinkTitle url="/usd/specifier" />という記事の「over」で
